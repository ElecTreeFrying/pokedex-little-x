...
export const options = {
  selectionList_1: [ 
    { option: 'ability', display: 'Ability', placeholder: 'ability', description: 'Abilities provide passive effects for pokémon in battle or in the overworld. Pokémon have multiple possible abilities but can have only one ability at a time.' },
  ...
  selectionList_6: [
    ...
    { option: 'stats', display: 'Stats', label1: 'Select stat', label2: 'Enter base stat', description: 'Stats determine certain aspects of battles. Each pokémon has a value for each stat which grows as they gain levels and can be altered momentarily by effects in battles.' }
  ]
};
